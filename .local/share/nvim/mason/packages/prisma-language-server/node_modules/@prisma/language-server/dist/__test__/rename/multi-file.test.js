...
(0, vitest_1.test)('rename model', async () => {
  ...
  `);
    (0, vitest_1.expect)(helper.applyChanges(response?.changes)).toMatchInlineSnapshot(`
    {
...
(0, vitest_1.test)('rename field - map exists', async () => {
    const helper = await (0, MultifileHelper_1.getMultifileHelper)('user-posts');
    const user = helper.file('User.prisma');
    const response = (0, MessageHandler_1.handleRenameRequest)(helper.schema, user.textDocument, {
        textDocument: {
...
(0, vitest_1.test)('rename field - map does not exist', async () => {
    const helper = await (0, MultifileHelper_1.getMultifileHelper)('user-posts');
    const user = helper.file('User.prisma');
    const response = (0, MessageHandler_1.handleRenameRequest)(helper.schema, user.textDocument, {
        textDocument: {

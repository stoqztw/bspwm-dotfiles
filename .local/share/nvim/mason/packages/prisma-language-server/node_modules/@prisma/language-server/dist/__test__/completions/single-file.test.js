...
(0, vitest_1.describe)('Completions', function () {
    ...
    (0, vitest_1.describe)('FIELD ATTRIBUTES', () => {
        ...
        (0, vitest_1.describe)('@default()', function () {
            vitest_1.test.each(['String', 'color', 'Int', 'Float', 'Boolean', 'DateTime'])('Scalar lists: %s', (scalarType) => {
                assertCompletion({
                    schema: /* Prisma */ `
              model Test {
                id    Int             @id
        ...
        (0, vitest_1.describe)('@default([|])', function () {
            ...
            const scalarTypesToExpectedCompletionItems = {
                Boolean: [
                    { label: 'true', kind: vscode_languageserver_1.CompletionItemKind.Value },
                    { label: 'false', kind: vscode_languageserver_1.CompletionItemKind.Value },
                ],
                color: [
                    { label: 'RED', kind: vscode_languageserver_1.CompletionItemKind.Value },
                    { label: 'GREEN', kind: vscode_languageserver_1.CompletionItemKind.Value },
                    { label: 'BLUE', kind: vscode_languageserver_1.CompletionItemKind.Value },
                ],
                Int: [],
                Float: [],
                DateTime: [],
            ...
            vitest_1.test.each(scalarTypes)('%s', (scalarType) => {
                assertCompletion({
                    schema: /* Prisma */ `
              model Test {
                id    Int             @id

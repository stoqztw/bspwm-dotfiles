...
async function updateTsgoSetting(enable) {
  const tsgoExtension = extensions.getExtension("typescript.typescript-lsp");
  if (!tsgoExtension) {
  ...
  if ((inspect == null ? void 0 : inspect.workspaceValue) !== void 0) {
    target = 2 /* Workspace */;
  } else if ((inspect == null ? void 0 : inspect.workspaceFolderValue) !== void 0) {
    ...
    if ((tsgoInspect == null ? void 0 : tsgoInspect.workspaceValue) !== void 0) {
      target = 2 /* Workspace */;
    } else if ((tsgoInspect == null ? void 0 : tsgoInspect.workspaceFolderValue) !== void 0) {
      target = 3 /* WorkspaceFolder */;
    }
  }
...
var EnableTsgoCommand, DisableTsgoCommand;
...
var init_api2 = __esm({
  "src/typescript-language-features/src/tsServer/api.ts"() {
    ...
    _API.v590 = _API.fromSimpleString("5.9.0");
    API = _API;
  }
});
  ...
  "src/typescript-language-features/src/tsServer/server.ts"() {
    ...
    _SingleTsServer = class _SingleTsServer extends Disposable {
      ...
      tryCancelRequest(request, command) {
        ...
        if ((callback == null ? void 0 : callback.traceId) !== void 0) {
        ...
        try {
          ...
          callback2 == null ? void 0 : callback2.onSuccess(new ServerResponse.Cancelled(`Cancelled request ${seq} - ${command}`));
        }
      }
      ...
      executeImpl(command, args, executeInfo) {
        ...
        if (executeInfo.expectsResult) {
          result = new Promise((resolve, reject) => {
            var _a;
            this._callbacks.add(request.seq, { onSuccess: resolve, onError: reject, queuingStartTime: Date.now(), isAsync: executeInfo.isAsync, traceId: (_a = request.arguments) == null ? void 0 : _a.$traceId }, executeInfo.isAsync);
        ...
        if (args && typeof args.$traceId === "string") {
          ...
          this._telemetryReporter.logTraceEvent("TSServer.enqueueRequest", args.$traceId, JSON.stringify({ command, queueLength, pendingResponses }));
        }
        this.sendNextRequests();
        return [result];
      }
      ...
      sendRequest(requestItem) {
        ...
        try {
          ...
          if (typeof ((_a = serverRequest.arguments) == null ? void 0 : _a.$traceId) === "string") {
...
function raceTimeout(promise, timeout, onTimeout) {
  ...
  const timer = setTimeout(() => {
    promiseResolve == null ? void 0 : promiseResolve(void 0);
...
var CopyMetadata, TsPasteEdit, TsPendingPasteEdit, enabledSettingId, _DocumentPasteProvider, DocumentPasteProvider;
  ...
  "src/typescript-language-features/src/languageFeatures/copyPaste.ts"() {
    ...
    TsPasteEdit = class _TsPasteEdit extends DocumentPasteEdit {
      static tryCreateFromResponse(client, response) {
        var _a;
        if (response.type !== "response" || !((_a = response.body) == null ? void 0 : _a.edits.length)) {
          return void 0;
        }
    ...
    _DocumentPasteProvider = class _DocumentPasteProvider {
      ...
      async provideDocumentPasteEdits(document2, ranges, dataTransfer, _context, token) {
        ...
        (_b = metadata == null ? void 0 : metadata.copyOperation) == null ? void 0 : _b.then((copyResponse) => {
      ...
      async extractMetadata(dataTransfer, token) {
        var _a;
        const metadata = await ((_a = dataTransfer.get(_DocumentPasteProvider.metadataMimeType)) == null ? void 0 : _a.value);
        if (token.isCancellationRequested) {
          return void 0;
        }
    ...
    _DocumentPasteProvider.kind = DocumentDropOrPasteEditKind.TextUpdateImports.append("jsts");
  ...
  "src/typescript-language-features/src/languageFeatures/hover.ts"() {
    ...
    TypeScriptHoverProvider = class {
      ...
      async provideHover(document2, position, token, context) {
        ...
        const enableExpandableHover = workspace.getConfiguration("typescript").get("experimental.expandableHover", true);
        let verbosityLevel;
...
function activate(context) {
  ...
  const config3 = workspace.getConfiguration("typescript");
  const useTsgo = config3.get("experimental.useTsgo", false);
  if (useTsgo) {
    commandManager.register(new DisableTsgoCommand());
    return {
      getAPI() {
  ...
  async codeAction(doc, params, token) {
    ...
    for (let i = 0; i < kinds.length; ++i) {
      ...
      for (const { id, provider, args } of providers) {
        if (vscKind && ((_c = (_b = args.metadata) == null ? void 0 : _b.providedCodeActionKinds) == null ? void 0 : _c.every((k) => !vscKind.contains(k)))) {
          continue;
        }
        ...
        if (!((_e = (_d = this.clientCapabilities.textDocument) == null ? void 0 : _d.codeAction) == null ? void 0 : _e.disabledSupport)) {
    ...
    if (results.length > 0) {
      ...
      if ((_g = (_f = this.clientCapabilities.textDocument) == null ? void 0 : _f.codeAction) == null ? void 0 : _g.resolveSupport) {
...
var configuration_expandableHover = "Enable expanding/contracting the hover to reveal more/less information from the TS server. Requires TypeScript 5.9+.";
